...
def build_lightning_module(
    ...
    if "custom_trainer" in cfg:
        ...
        #model cfg에 추가했으면 여기에다가 추가해줄것
        if hasattr(cfg.model, 'EMER_setting_dict'):
            instantiation_args['EMER_dict'] = cfg.model.EMER_setting_dict
        model = instantiate(cfg.custom_trainer, **instantiation_args)
