...
class AbstractPlanner(abc.ABC):
    ...
    def compute_trajectory(self, current_input: PlannerInput, scenario_token, scenario_type, scenario) -> AbstractTrajectory:
        """
        ...
        try:
            trajectory = self.compute_planner_trajectory(current_input, scenario_token, scenario_type, scenario)
